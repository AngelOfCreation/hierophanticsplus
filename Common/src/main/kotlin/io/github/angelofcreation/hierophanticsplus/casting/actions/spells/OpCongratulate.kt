package io.github.angelofcreation.hierophanticsplus.casting.actions.spells
...
object OpCongratulate : SpellAction {
    ...
    private data class Spell(val target: Entity) : RenderedSpell {
        ...
        override fun cast(env: CastingEnvironment) {
            env.printMessage("text.hierophantics_plus.congrats".asTranslatedComponent(target.displayName));
        }
    }
}
