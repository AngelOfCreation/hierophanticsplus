...
public abstract class MixinDatagenMain {
    ...
    private static void hierophantics_plus$systemExitAfterDatagenFinishes(String[] strings, Operation<Void> original) {
        try {
            original.call((Object) strings);
        } catch (Throwable throwable) {
            HierophanticsPlus.LOGGER.error("Datagen failed!", throwable);
            System.exit(1);
        }
        HierophanticsPlus.LOGGER.info("Datagen succeeded, terminating.");
        System.exit(0);
    }
}
