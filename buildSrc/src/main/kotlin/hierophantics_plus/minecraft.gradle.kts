...
package hierophantics_plus

import kotlin.io.path.div
import libs

plugins {
    id("hierophantics_plus.java")
...
loom {
    ...
    accessWidenerPath = project(":Common").file("src/main/resources/hierophantics_plus.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hierophantics_plus-common-Common-refmap.json
        // fixed:   hierophantics_plus-common.refmap.json
