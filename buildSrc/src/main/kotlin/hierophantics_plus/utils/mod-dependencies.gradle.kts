package hierophantics_plus.utils
...
abstract class HierophanticsPlusModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HierophanticsPlusModDependenciesExtension>("hierophanticsplusModDependencies")
