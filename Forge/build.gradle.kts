plugins {
    id("hierophantics_plus.platform")
}
...
loom {
    forge {
        ...
        mixinConfig(
            "hierophantics_plus-common.mixins.json",
            "hierophantics_plus-forge.mixins.json",
        )
    }
    ...
    runs {
        for ((platform, outputProject) in arrayOf(
            ...
            register("${platform}Datagen") {
                ...
                property("hierophantics_plus.apply-datagen-mixin", "true")
                property("hierophantics_plus.$platform-datagen", "true")
            }
        }
    }
}

hierophanticsplusModDependencies {
